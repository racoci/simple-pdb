...
// Main interface representing the complete profile data.
export interface ProfileResponse {
  ...
  related_subcat_link_info?: SubcatLinkInfo | null;
...
// Provides link information for subcategory grouping.
...
// Structure of a related profile item.
...
// Describes a system entry, e.g. Four Letter, Enneagram, etc.
...
// A map for breakdown systems by system key.
export interface BreakdownSystems {
  [key: string]: BreakdownSystemItem[];
}

// Each item in the breakdown systems.
...
// Breakdown configuration with keys mapping to numbers.
export interface BreakdownConfig {
  expand: { [key: string]: number };
  fire: { [key: string]: number };
}

// Statistics on MBTI letters.
...
// Topic information about the profile.
...
// Basic topic structure; similar to ProfileResponse fields for topic detail.
...
// Related topic information; optionally including image details.
...
// Posts object; you can refine this if you know the structure of each post.
